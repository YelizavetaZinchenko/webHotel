...
public final class Requests {
    ...
    public static final String SELECT_BILL_STATUS_BY_ID = "SELECT bill FROM room WHERE id_user = ?);";
    ...
    public static final String UPDATE_ROOM_BILL_BY_ID = "UPDATE room SET bill=true WHERE id_room = ?";
    ...
    public static final String INSERT_APPLICATION = "INSERT INTO application (user_id, price, amountOfSeats, classOfRoom, statusOfRoom) VALUES (?, ?, ?, ?, ?)";
